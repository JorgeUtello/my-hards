...
class Server:
    def __init__(self, config: dict):
        ...
        # Skip-once flag: skip the single synthetic event generated by our warp
    ...
    def _on_mouse_move(self, x: int, y: int):
        ...
        if self.active:
            # Compute delta from last known anchor, forward to client
            dx = x - self._last_x
            dy = y - self._last_y
        ...
        # Not active: only detect edge if our app has focus
